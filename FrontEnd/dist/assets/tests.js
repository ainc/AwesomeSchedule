...
define('awesome-schedule-front/tests/controllers/calendarTile.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - controllers');
  QUnit.test('controllers/calendarTile.js should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/calendarTile.js should pass jshint.\ncontrollers/calendarTile.js: line 2, col 1, \'export\' is only available in ES6 (use \'esversion: 6\').\n\n1 error');
  });
});
