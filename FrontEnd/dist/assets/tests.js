...
define('awesome-schedule-front/tests/components/calendar-view-main.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - components/calendar-view-main.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/calendar-view-main.js should pass jshint.');
  });
});
...
define('awesome-schedule-front/tests/controllers/bio-box.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - controllers/bio-box.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/bio-box.js should pass jshint.');
  });
});
...
define('awesome-schedule-front/tests/controllers/coach.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - controllers/coach.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'controllers/coach.js should pass jshint.');
  });
});
...
define('awesome-schedule-front/tests/helpers/day-check.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - helpers/day-check.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'helpers/day-check.js should pass jshint.');
  });
});
...
define('awesome-schedule-front/tests/helpers/format-date.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'helpers/format-date.js should pass jshint.\nhelpers/format-date.js: line 13, col 16, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 20, col 13, \'today\' is already defined.\nhelpers/format-date.js: line 21, col 13, \'tomorrow\' is already defined.\nhelpers/format-date.js: line 23, col 16, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 30, col 16, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 35, col 21, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 41, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 43, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 45, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 47, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 49, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 51, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 57, col 21, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 63, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 65, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 67, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 69, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 71, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 73, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 79, col 21, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 85, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 87, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 89, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 91, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 93, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 95, col 24, Missing \'new\' prefix when invoking a constructor.\nhelpers/format-date.js: line 100, col 16, Missing \'new\' prefix when invoking a constructor.\n\n27 errors');
  });
});
...
define('awesome-schedule-front/tests/integration/components/calendar-view-main-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleForComponent)('calendar-view-main', 'Integration | Component | calendar view main', {
    integration: true
  });
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template((function () {
      return {
        ...
        statements: [['content', 'calendar-view-main', ['loc', [null, [1, 0], [1, 22]]]]],
        locals: [],
        templates: []
      };
    })()));
    ...
    this.render(Ember.HTMLBars.template((function () {
      ...
      return {
        ...
        statements: [['block', 'calendar-view-main', [], [], 0, null, ['loc', [null, [2, 4], [4, 27]]]]],
        locals: [],
        templates: [child0]
      };
    })()));
...
define('awesome-schedule-front/tests/integration/components/calendar-view-main-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - integration/components/calendar-view-main-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/calendar-view-main-test.js should pass jshint.');
  });
});
...
define('awesome-schedule-front/tests/models/coach.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - models/coach.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'models/coach.js should pass jshint.');
  });
});
...
define('awesome-schedule-front/tests/routes/bio-box.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - routes/bio-box.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/bio-box.js should pass jshint.');
  });
});
...
define('awesome-schedule-front/tests/unit/controllers/bio-box-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleFor)('controller:bio-box', 'Unit | Controller | bio box', {
...
define('awesome-schedule-front/tests/unit/controllers/bio-box-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - unit/controllers/bio-box-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/bio-box-test.js should pass jshint.');
  });
});
define('awesome-schedule-front/tests/unit/controllers/coach-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleFor)('controller:coach', 'Unit | Controller | coach', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
...
define('awesome-schedule-front/tests/unit/controllers/coach-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - unit/controllers/coach-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/coach-test.js should pass jshint.');
  });
});
...
define('awesome-schedule-front/tests/unit/helpers/day-check-test', ['exports', 'awesome-schedule-front/helpers/day-check', 'qunit'], function (exports, _awesomeScheduleFrontHelpersDayCheck, _qunit) {

  (0, _qunit.module)('Unit | Helper | day check');

  // Replace this with your real tests.
  (0, _qunit.test)('it works', function (assert) {
    var result = (0, _awesomeScheduleFrontHelpersDayCheck.dayCheck)([42]);
    assert.ok(result);
  });
});
define('awesome-schedule-front/tests/unit/helpers/day-check-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - unit/helpers/day-check-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/helpers/day-check-test.js should pass jshint.');
  });
});
...
define('awesome-schedule-front/tests/unit/models/person-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
...
define('awesome-schedule-front/tests/unit/models/person-test.jshint', ['exports'], function (exports) {
  'use strict';
...
define('awesome-schedule-front/tests/unit/routes/bio-box-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleFor)('route:bio-box', 'Unit | Route | bio box', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
...
define('awesome-schedule-front/tests/unit/routes/bio-box-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - unit/routes/bio-box-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/bio-box-test.js should pass jshint.');
  });
});
