...
define('ember-bootstrap/components/bs-form-element', ['exports', 'ember', 'ember-bootstrap/components/bs-form-group', 'ember-bootstrap/components/bs-form'], function (exports, _ember, _emberBootstrapComponentsBsFormGroup, _emberBootstrapComponentsBsForm) {
  ...
  exports['default'] = _emberBootstrapComponentsBsFormGroup['default'].extend({
     ...
     * @private
     */
    formElementId: _ember['default'].computed('elementId', function () {
    ...
    formElementTemplate: _ember['default'].computed('formLayout', 'controlType', function () {
...
define('ember-bootstrap/components/bs-progress-bar', ['exports', 'ember', 'ember-bootstrap/mixins/type-class'], function (exports, _ember, _emberBootstrapMixinsTypeClass) {
  ...
  exports['default'] = _ember['default'].Component.extend(_emberBootstrapMixinsTypeClass['default'], {
    ...
    progressBarStriped: _ember['default'].computed.alias('striped'),
    active: _ember['default'].computed.alias('animate'),

    ariaValuenow: _ember['default'].computed.alias('value'),
    ariaValuemin: _ember['default'].computed.alias('minValue'),
    ariaValuemax: _ember['default'].computed.alias('maxValue'),
     ...
     * @readonly
     */
    percent: _ember['default'].computed('value', 'minValue', 'maxValue', function () {
     ...
     * @readonly
     */
    percentRounded: _ember['default'].computed('percent', 'roundDigits', function () {
     ...
     * @readonly
     */
    style: _ember['default'].computed('percent', function () {
